var taskDescriptions = {
    taskA: "одно натуральное число",
    taskB: "одно натуральное число",
    taskC: "одно натуральное число",
    taskD: "два целых числа от 0 до 70 в одну строку через пробел",
    taskE: "одно натуральное число",
    taskF: "одно натуральное число",
    taskG: "одно натуральное число",
    taskH: "натуральное число N на первой строке, N натуральных чисел через пробел на второй строке",
    taskI: "натуральное число N на первой строке, N натуральных чисел через пробел на второй строке",        
    taskJ: "одно натуральное число"
  };
