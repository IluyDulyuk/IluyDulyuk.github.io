...
window.addEventListener('DOMContentLoaded', function () {
  var links = document.querySelectorAll('.header__link > a'),
    offerArrow = document.querySelector('.offer__arrow');
  links.forEach(function (link) {
    link.addEventListener('click', function (e) {
      e.preventDefault();
      document.querySelector(".".concat(link.getAttribute('data-scroll'))).scrollIntoView({
        behavior: 'smooth',
        block: 'start'
      });
    });
  });
  offerArrow.addEventListener('click', function () {
