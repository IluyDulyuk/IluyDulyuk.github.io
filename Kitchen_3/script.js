...
var menu = function menu() {
  var mobileMenu = document.querySelector('.header__nav'),
      headerGum = document.querySelector('.header__gum'),
  ...
  headerGum.addEventListener('click', function () {
    mobileMenu.classList.add('_mobile-menu-open');
    headerBg.classList.add('_mobile-bg-show');
  ...
  headerClose.addEventListener('click', function () {
    mobileMenu.classList.remove('_mobile-menu-open');
    headerBg.classList.remove('_mobile-bg-show');
    document.body.style.overflow = '';
    footerLinks.forEach(function (link) {
      link.style.opacity = '0.5';
    });
  });
  var dropdownLinks = document.querySelectorAll('.menu__item._dropdown');
