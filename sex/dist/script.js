...
var cart = function cart() {
  var buttons = document.querySelectorAll('.cart__btn');
  buttons.forEach(function (item) {
    item.addEventListener('click', function () {
      buttons.forEach(function (el) {
        el.textContent = 'Показать телефон';
        var number = item.getAttribute('data-number');
        item.textContent = "".concat(number);
      });
    });
  });
};
...
var menu = function menu() {
  var menuItems = document.querySelectorAll('.menu__item'),
      ...
      indexWrapper = document.querySelector('.index__girl');
  menuItems.forEach(function (item) {
    item.querySelector('.menu__no-hide').addEventListener('click', function () {
...
var search = function search() {
  var searchItems = document.querySelectorAll('.search__item'),
      listItems = document.querySelectorAll('.list-item > li');
  searchItems.forEach(function (item) {
    var btn = item.querySelector('.search__item_right'),
        text = item.querySelector('.search__item_btn-close'),
        arrow = item.querySelector('.search__item_icon-close');
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_components_menu__WEBPACK_IMPORTED_MODULE_1__["default"])();
  Object(_components_cart__WEBPACK_IMPORTED_MODULE_2__["default"])();
  Object(_components_search__WEBPACK_IMPORTED_MODULE_3__["default"])();
});
