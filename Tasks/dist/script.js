...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var Task = /*#__PURE__*/function () {
    ...
    _createClass(Task, [{
      ...
      value: function render() {
        ...
        el.innerHTML = this.task;
        taskWrapper.append(el);
      }
    }]);
  ...
  renderTask(); // Добавление элемента

  var addOpenBtn = document.querySelector('.add-btn'),
      addBlock = document.querySelector('.add-block'),
      addCloseBtn = addBlock.querySelector('.cancel-btn'),
      input = addBlock.querySelector('input'),
      addBtn = addBlock.querySelector('.add-block__add-btn');
  addOpenBtn.addEventListener('click', function () {
    addBlock.classList.add('active');
    addOpenBtn.style.display = 'none';
  });
