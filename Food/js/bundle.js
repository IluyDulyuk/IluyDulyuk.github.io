...
var cards = function cards() {
  var MenuCard = /*#__PURE__*/function () {
    function MenuCard(src, alt, title, descp, price, perent) {
      ...
      this.src = src, this.alt = alt, this.title = title, this.descp = descp, this.price = price, this.perent = document.querySelector(perent), this.classes = classes, this.chengeUAH();
    }

    _createClass(MenuCard, [{
      key: "chengeUAH",
      value: function chengeUAH() {
...
var forms = function forms() {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', function (e) {
      ...
      Object(_services_services_js__WEBPACK_IMPORTED_MODULE_9__["postData"])('http://localhost:3000/requests', json).then(function (data) {
        console.log(data);
  ...
  function showResponseModal(messege) {
    ...
    Object(_modal__WEBPACK_IMPORTED_MODULE_8__["openModal"])('.modal');
...
var modal = function modal(modalSelector, triggerSelector) {
  var modal = document.querySelector(modalSelector),
      triggerModal = document.querySelectorAll(triggerSelector); //   modalCloseBtn = document.querySelector('[data-close]');

  triggerModal.forEach(function (btn) {
...
var slider = function slider(_ref) {
  var content = _ref.content,
      ...
      inner = _ref.inner;
  var slider = document.querySelector(content),
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_6__["default"])('.timer', dedline);
});
